function examples(options){
    ...
    var examples = [
        ...
        + '//type. However, you can use mixed which is the parent type of all\n'
        ...
        + '$m = new Exception();\n'
        + '\n'
        + '//Yet, if you want to pass a variable of type mixed to a function or\n'
        ...
        + '//should use mixed only in very rare cases.\n'
        + '\n'
        ...
        + '\n'
        + '\n'
        + '//Uninitialised variables - each variable has to be initialised before\n'
        + '//its first usage.\n'
        + '\n'
        ...
        + 'for(int $i = 0; $i < 10; ++$i){}\n' 
        + '\n'
        + 'foreach([1,2] as string $k => mixed $v){}\n'
        + '\n'
        + '//A little bit cumbersome is the definition of variables within the\n'
        + '//foreach-header at the moment. Only "string" for keys and "mixed"\n'
        + '//for values are valid at this time, since typed array\'s are not yet\n'
        ...
        //----------------------------------------------------------------------------
          '//See example "control structures - basics" for an introduction. The \n'
        + '//examples show what is not allowed in TSPHP (in contrast to PHP).\n'
        + '\n'
        ...
        + '//nullable equivalent. Again, TSPHP does not apply a type juggling auto-\n'
        ...
        + '//mixed. The following would cause a compiler exception:\n'
        + '\n'
        ...
        + '//As in C#, a question mark is appended to the specific scalar type:\n'
        + '\n'
        + 'int? $i = 0;\n'
        + '$i = null;\n'
        + '\n'
        ...
        + '//be hold by such a variable. Following an example:\n'
        + '\n'
        + '//PHP\'s built-in functions are not yet supported by TSPHP thus a stub\n'
        + 'function int! strpos(string $haystack, string $needle) {\n'
        + '    int! $pos = false;\n'
        ...
        + '}\n'
        + '\n'
        + '//when you call the function strpos you get back the position of $needle\n'
        + '//in $haystack, false if $needle could not be found respectively.\n'
        + '//Falseable was especially developed for users with the preference to\n'
        + '//return false on error.'
        + '//Manual for more information about nullable:\n'
        + '//http://tsphp.ch/wiki/display/TSPHP/Falseable\n'
        ,
    ];
    var functions = {
        show:
